...
flags.DEFINE_integer("num_epoch", 8, "Number of epoch")
flags.DEFINE_integer("checkpoint", 400, "checkpoint to save and evaluate the model")
...
flags.DEFINE_float("grad_clip",10, "Global Norm gradient clipping rate")
